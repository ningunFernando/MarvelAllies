...
class CharacterDetails : Fragment()
{
     ...
     */
    private lateinit var _nameLayout: TextView
    private lateinit var _bioLayout: TextView
    private lateinit var _recyclerView: RecyclerView
    private lateinit var _recyclerAbilities: RecyclerView
    ...
    ): View
    {
        ...
        _nameLayout = view.findViewById(R.id.Name)
        _bioLayout = view.findViewById(R.id.Bio)
        _recyclerView = view.findViewById(R.id.RecyclerSkin)
        _recyclerAbilities = view.findViewById(R.id.RecyclerAbilities)
        ...
        _recyclerAbilities.layoutManager = LinearLayoutManager(requireContext())
        /*
        ...
        _nameLayout.text = characterName?.uppercase()
        /*
            ...
            .enqueue(object : Callback<Hero>
            {
                override fun onResponse(call: Call<Hero>, response: Response<Hero>)
                {
                    ...
                    response.body()?.let { hero ->
                         ...
                         */
                        _recyclerView.adapter = SkinAdapter(hero.costumes)
                        _recyclerAbilities.adapter = AbilitiesAdapter(hero.abilities)
                    }
                }
